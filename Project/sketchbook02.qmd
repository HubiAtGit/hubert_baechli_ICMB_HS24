...
```{r}
SubPop <- sel_SubPop( Pop = Pop , IDs = c(1,2))
SubPop$sel
SubPop$rest
```
...
A learning process with uptated LearnRate by actual Knowledge when to Agents meet randomly
